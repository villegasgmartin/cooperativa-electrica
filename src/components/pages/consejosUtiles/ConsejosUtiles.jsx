    ...
    <section className='consejos-main-container'>
      <div className='consejos-container'>
        <Fade triggerOnce={true} duration={800} delay={300}>
          <div className='consejos-text-container'>
            <h3 className='consejos-number'>"1"</h3>
      ...
      <div className='consejos-container' id='dark-background'>
        <Fade triggerOnce={true} duration={800} delay={300}>
          ...
          <div className='consejos-text-container'>
            <h3 className='consejos-number'>"2"</h3>
      ...
      <div className='consejos-container'>
        <Fade triggerOnce={true} duration={800} delay={300}>
          <div className='consejos-text-container'>
            <h3 className='consejos-number'>"3"</h3>
      ...
      <div className='consejos-container' id='dark-background'>
        <Fade triggerOnce={true} duration={800} delay={300}>
          ...
          <div className='consejos-text-container'>
            <h3 className='consejos-number'>"4"</h3>
      ...
      <div className='consejos-container'>
        <Fade triggerOnce={true} duration={800} delay={300}>
          <div className='consejos-text-container'>
            <h3 className='consejos-number'>"5"</h3>
