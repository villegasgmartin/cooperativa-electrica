...
const Laboratorio = () => {
  ...
  return (
    <section className='laboratorio-main-container'>
      ...
      <div className='laboratorio-info-container laboratorio-containerPadding' id='laboratorio-container-direction'>
        <Fade triggerOnce={true} duration={800} delay={300} direction='right'>
          ...
          <div className='laboratorio-text-container'>
            <h2 className='laboratorio-title laboratorio-titleStyle01'>"LACOP"</h2>
      ...
      <div className='laboratorio-info-container' id='laboratorio-container-direction'>
        <Fade triggerOnce={true} duration={800} delay={300} direction='right'>
          <div className='laboratorio-image-container'><img src={LabImage03} alt="imágen de laboratorio de medidores" className='laboratorio-image'/></div>
          <div className='laboratorio-text-container'>
      ...
      <div className='laboratorio-info-container' id='dark-background-lab'>
        <Fade triggerOnce={true} duration={800} delay={300} direction='left'>
          ...
          <h2 className='laboratorio-title' id='light-font'>Importancia del servicio técnico a prestar. <span className='laboratorio-titleStyle02'>Equipamiento</span></h2>
            ...
            <h2 className='laboratorio-title' id='light-font'><span className='laboratorio-titleStyle02'>Metas</span> de capacitación al personal</h2>
