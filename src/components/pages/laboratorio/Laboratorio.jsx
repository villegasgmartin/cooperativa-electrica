  ...
  return (
    <section className='laboratorio-main-container'>
      <div className='laboratorio-info-container'>
        <img src={LabImage01} alt="imágen de laboratorio de medidores" className='laboratorio-image'/>
      ...
      <div className='laboratorio-info-container' id='dark-background'>
        ...
        <img src={LabImage02} alt="imágen de laboratorio de medidores" className='laboratorio-image'/>
      </div>
      <div className='laboratorio-info-container'>
        <img src={LabImage03} alt="imágen de laboratorio de medidores" className='laboratorio-image'/>
        <div className='laboratorio-text-container'>
          <h2 className='laboratorio-title'>Importancia del servicio técnico a prestar. <span className='color-title'>Equipamiento</span></h2>
          <p className='laboratorio-text'>La medición de la energía eléctrica que suministran las cooperativas distribuidoras a sus socios o clientes, es un punto de vital importancia para la economía de las mismas, que hace a la calidad y eficiencia de la correcta facturación, -en salvaguarda de los derechos del usuario-, por lo que queda de manifiesto la importancia de medir los consumos sin márgenes de error.<br/>
