...
import "../ServicioBaja/ServicioBaja.css"
  ...
  return (
    <Fade triggerOnce={true} duration={800} delay={100}>
        <div className='servicioComponents-container'> 
          <div>
            <h2 className='servicio-title'>Dar de baja el servicio</h2>
            <p className='servicio-description'>Solicitá el retiro del medidor, tené en cuenta que tu hogar o comercio se quedará sin servicio</p>
          </div>
          <div>
          ...
          <Link to="/preguntas-frecuentes#pregunta-21" className='servicio-info'>Más información</Link>
      </div>
    </Fade>
  )
}

export default ServicioBaja