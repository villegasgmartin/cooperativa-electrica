...
//JSX:
const ServicioReconexion = () => {
  return (
    <Fade triggerOnce={true} duration={800} delay={100}>
        <div className='servicioComponents-container'>
        <div>
          <h2 className='servicio-title'>Reinstalación del servicio</h2>
          <p className='servicio-description'>Poné el servicio que fue dado de baja a tu nombre.</p>
        </div>
        <div>
...
export default ServicioReconexion