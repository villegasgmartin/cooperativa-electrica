...
//PDF:
        ...
        doc.save('Área-Técnica-Pendientes.pdf');
        };
...
return (
    ...
    <TableRow hover>
        ...
        <Button
            ...
            onClick={() => onMarcarRealizada(registro)}
        >
            Realizada
        </Button>
        </TableCell>
    ...
    <TableRow>
        ...
        <Collapse in={open} timeout="auto" unmountOnExit>
            ...
            <ul>
                ...
                {registro.nombre?.trim() || registro.apellido?.trim()
                ...
                <li>
                <strong>Observaciones:</strong> {registro.descripcion}
                </li>
            </ul>
            </Box>
        </Collapse>
