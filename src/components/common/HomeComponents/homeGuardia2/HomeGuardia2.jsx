...
const HomeGuardia2 = () => {
    return (
        <section className="HomeGuardia-container2">
                <div className="HomeGuardia-buttonContainer2-column">
                    <Fade triggerOnce={true} duration={800} direction="up" delay={300}>
            ...
            <Fade triggerOnce={true} duration={800} delay={300}><div className="imagenGuardia2"></div></Fade>
            <div className="HomeGuardia-infoContainer2">
            <Fade triggerOnce={true} duration={800} direction="right" delay={300}>
                <h2 className="HomeGuardia-title2">Servicio <span className="color-title2">Eléctrico</span></h2>
